...
def start_loop(predictor_name):
    ...
    _utils.logger.info(f"Imported predictor: {predictor_name} predictor_sequence: {predictor_sequence}, optimal_batch_size: {optimal_batch_size}, max_wait_time_for_batch_collection: {max_wait_time_for_batch_collection}")
