...
red, green, yellow, black = '\x1b[38;5;1m', '\x1b[38;5;2m', '\x1b[38;5;3m', '\x1b[38;5;0m'
...
if not os.path.exists('./requirements.txt') or not os.path.exists('./predictor.py') or not os.path.exists('./example.pkl'):
    print(f'{red} Your folder must contain a file called requirements.txt and predictor.py {black}')
    quit()
